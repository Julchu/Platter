...
let catererProfileRouter = require('./routes/catererProfile');
...
// Passport sessions
app.use(session({ secret: 'Saveury', resave: false, saveUninitialized: false }));
...
app.use('/catererProfile', catererProfileRouter);
